...
<body>
            ...
            <tr>
                ...
                <td class="text-right" style="vertical-align: top;">
                    <div style="font-size: 7.5pt; color: #6b7280;">
                        Ngày xuất: {{ date('d/m/Y H:i') }}<br/>
                        Tác giả: {{ auth('api')->user()?->ho_ten ?? 'Kế toán hệ thống' }}
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="report-header">
        <h1 class="report-title">@yield('report_name')</h1>
        <div class="report-meta">
            Khoảng thời gian: <strong>{{ $periodText }}</strong>
        </div>
    </div>
