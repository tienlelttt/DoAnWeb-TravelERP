...
- Nhân viên đÝđăng nhập vào hệ thống và có quyền truy cập
Tiền điều kiện
...
Sao chép tour mẫu.
- Nậ¿u chọn "Cập nhật thông tin", hệ thống thực hiện UC04:
Cập nhật tour mẫu.
...
sách, sẵn sàng cho việc thiậ¿t lập lịch trình chi tiậ¿t.
...
thiậ¿t lập chi tiậ¿t hoạt động cho từng ngày.


### 5. Nhân viên nhấn nút "Lưu".
### 6. Hệ thống thực hiện kiểm tra tính hợp lệ của dữ liệu tour
mẫu và tính trọn vậ¹n của lịch trình đÝnhập tại UC08.
...
sẵn.
- Nhân viên đÝđăng nhập thành công vào hệ thống.
Tiền điều kiện
- Nhân viên đang ở giao diện danh sách tour mẫu.
- Một bản ghi tour mẫu mới được tạo trong CSDL với mÃ
Hậu điều kiện
...
chiậ¿n lược kinh doanh hoặc bị nhập lỗi.
- Nhân viên đÝđăng nhập thành công vào hệ thống.
Tiền điều kiện
- Nhân viên đang ở giao diện danh sách tour mẫu.
...
chính xác nhận lại quyậ¿t định xóa.
...
từ CSDL.
### 2. Nhân viên nhập từ khóa tìm kiậ¿m (tên tour, mÝtour) hoặc
...
Tác nhân Nhân viên sản phẩm
Cho phép nhân viên thiậ¿t lập và duy trì các hoạt động chi tiậ¿t
Mô tả
...
Tác nhân Nhân viên sản phẩm
Cho phép nhân viên sản phẩm thiậ¿t lập chi tiậ¿t các hoạt động,
Mô tả điểm tham quan và thực đơn theo từng ngày cho một tour
mẫu cụ thể.
- Nhân viên đÝđăng nhập và có quyền truy cập chức năng
Quản lý lịch trình.
Tiền điều kiện
...
### 3. Nhân viên lần lượt nhập nội dung chi tiậ¿t cho từng ngày
...
Luồng sự kiện Không có
phụ
5a. Nậ¿u phát hiện có phân đoạn chưa được nhập nội dung,
...
### 6. Hệ thống ghi nhận các thay đổi và cập nhật trực tiậ¿p vào
...
tin vận hành, tra cứu và loại bỏ các chuyậ¿n tour không còn
phù hợp.
- Nhân viên phải đăng nhập vào hệ thống.
...
thiậ¿t lập các thông số vận hành của tour.
- Nhân viên phải đăng nhập vào hệ thống.
...
3a. Nậ¿u tour đÝhoàn thành hoặc đang trong quá trình vận
...
### 8. Hệ thống hiển thị thông báo "Cập nhật thông tin chuyậ¿n
tour thành công".
...
Hậu điều kiện - Hiển thị các chuyậ¿n tour phù hợp với điều kiện tìm kiậ¿m.
...
- Nhân viên đÝđăng nhập vào hệ thống và có quyền quản lý
...
Luồng sự kiện Không có
phụ
5a. Nậ¿u thông tin nhập không hợp lệ, hệ thống yêu cầu nhân
...
Luồng sự kiện 6a. Nậ¿u thông tin nhập không hợp lệ, hệ thống yêu cầu nhân
...
Tác nhân Nhân viên sản phẩm
Cho phép nhân viên sản phẩm thiậ¿t lập danh sách các hành
...
tour.
- Nhân viên sản phẩm đÝđăng nhập vào hệ thống và có
