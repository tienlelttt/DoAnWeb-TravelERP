...
Hệ thống được thiậ¿t kậ¿ với 10 Actor chính tham gia vào các quá trình vận hành:
...
| 4 | Nhân viên kinh doanh | Nhân viên bộ phận kinh doanh, quản lý đơn hàng, tư vấn khách hàng, quản lý voucher và chương trình khuyậ¿n mÃi. |
...
| 7 | Nhân viên kậ¿ toán | Nhân viên bộ phận tài chính, thực hiện đối soát thanh toán, quyậ¿t toán tour và trích xuất báo cáo tài chính. |
...
| 10 | Hệ thống Power BI (External System) | Hệ thống bên thứ ba tiậ¿p nhận dữ liệu từ ERP để trực quan hóa và phân tích báo cáo. |
...
### Phân hệ 2: Quản lý Hộ chiếu số ([Xem chi tiậ¿t](02-quan-ly-ho-chieu-so.md))
| MÝUC | Tên Use-case | Tác nhân chính |
|---|---|---|
...
### Phân hệ 5: Quản lý Vận hành Mobile ([Xem chi tiậ¿t](05-quan-ly-van-hanh-mobile.md))
| MÝUC | Tên Use-case | Tác nhân chính |
|---|---|---|
...
| UC44 | Cập nhật chi phí thực tậ¿ | HDV |

### Phân hệ 6: Quản lý Tài chính - Kậ¿ toán ([Xem chi tiậ¿t](06-quan-ly-tai-chinh.md))
| MÝUC | Tên Use-case | Tác nhân chính |
|---|---|---|
| UC45 | Tính lợi nhuận gộp | Nhân viên kậ¿ toán |
