...
| Luồng sự kiện chính | 1. Khách hàng nhấn chọn chức năng "Tìm kiếm tour" trên thanh menu của hệ thống.<br>2. Hệ thống hiển thị các trường dữ liệu: Điểm đến, Ngày khởi hành, Mức giá tối đa.<br>3. Khách hàng nhập thông tin tìm kiếm.<br>4. Khách hàng nhấn nút "Tìm kiếm".<br>5. Hệ thống kiểm tra dữ liệu.<br>6. Hệ thống tính toán giá động theo thời gian thực.<br>7. Hệ thống hiển thị danh sách kết quả (Card view) gồm: ậ¢nh, Lịch trình, Giá động, Số chỗ còn nhận.<br>8. Kết thúc use case. |
...
| Tiền điều kiện | - Khách hàng đãđăng nhập thành công và đang xem chi tiết một chuyến đi cụ thể còn nhận khách. |
...
| Tác nhân | Khách hàng |
| Mô tả | Khách hàng lựa chọn mãgiảm giá phù hợp từ ví để áp dụng cho đơn hàng đang thực hiện. |
...
| Luồng sự kiện chính | 1. Tại bước tổng kết đơn hàng, nhấn "Chọn/Nhập mãgiảm giá".<br>2. Hệ thống truy xuất và ưu tiên hiển thị danh sách các mãphù hợp.<br>3. Khách hàng chọn mãmuốn sử dụng.<br>4. Hệ thống kiểm tra tính hợp lệ của mÃ.<br>5. Hệ thống "Tạm khóa" voucher này, tính toán lại và cập nhật tổng số tiền cuối cùng.<br>6. Kết thúc use case. |
| Luồng sự kiện phụ | Không có |
...
| Hậu điều kiện | - Trạng thái đơn hàng cập nhật thành "Đãxác nhận".<br> - Vé điện tử phát hành, gửi cho khách hàng.<br> - Số chỗ trống được trừ chính thức. |
| Luồng sự kiện chính | 1. Chọn phương thức thanh toán khả dụng.<br>2. Khách hàng nhấn "Thanh toán".<br>3. Hệ thống thiết lập kết nối an toàn với cổng thanh toán.<br>4. Chuyển hướng đến giao diện thanh toán.<br>5. Thực hiện thanh toán với cổng thanh toán tương ứng.<br>6. Hệ thống nhận phản hồi thành công, cập nhật trạng thái đơn hàng sang "Đãxác nhận".<br>7. Ghi nhận đơn hàng vào CSDL.<br>8. Phát hành vé điện tử (mã QR).<br>9. Gửi thông báo xác nhận kèm vé điện tử.<br>10. Kết thúc use case. |
...
| Tiền điều kiện | - Đãđăng nhập tài khoản. |
...
| Tác nhân | Khách hàng |
| Mô tả | Xem danh sách các mãgiảm giá hiện có trong ví cá nhân. |
| Tiền điều kiện | - Đãđăng nhập và đang ở trang cá nhân hoặc ví ưu đÃi. |
...
| Luồng sự kiện phụ | 2a. Nếu không có mãgiảm giá nào, hiển thị thông báo kèm nút điều hướng đến UC30. |
...
| Tác nhân | Khách hàng |
| Mô tả | Thực hiện yêu cầu hủy một chuyến đi đãxác nhận trước đó. |
| Tiền điều kiện | - Có ít nhất một đơn hàng đãđược xác nhận và chưa đến ngày khởi hành. |
| Hậu điều kiện | - Đơn hàng chuyển sang "Đã hủy".<br> - Chỗ đãđặt được trả lại.<br> - Yêu cầu hoàn tiền được khởi tạo. |
| Luồng sự kiện chính | 1. Truy cập "Chuyến đi của tôi".<br>2. Hệ thống hiển thị danh sách các chuyến đi.<br>3. Chọn một chuyến đi sắp khởi hành và nhấn "Hủy tour".<br>4. Hệ thống kiểm tra điều kiện hủy.<br>5. Tính toán mức phí phạt hủy.<br>6. Hiển thị bảng xác nhận hủy tour.<br>7. Nhấn "Xác nhận hủy tour".<br>8. Cập nhật trạng thái thành "Đã hủy".<br>9. Thu hồi mãvé, trả lại chỗ.<br>10. Gửi thông báo xác nhận.<br>11. Gọi thực thi UC33 - Hoàn tiền.<br>12. Kết thúc use case. |
...
| Luồng sự kiện chính | 1. Tự động khởi tạo yêu cầu hoàn tiền.<br>2. Truy xuất thông tin giao dịch gốc.<br>3. Tính toán số tiền thực hoàn.<br>4. Tạo bản ghi yêu cầu hoàn tiền với trạng thái "Chờ kế toán duyệt".<br>5. Hiển thị trạng thái đơn: "Đang xử lý hoàn tiền".<br>6. Chuyển sang UC50 â€“ Xử lý hoàn tiền.<br>7. Cập nhật trạng thái đơn hàng và gửi thông báo.<br>8. Kết thúc use case. |
