...
- [x] Thiậ¿t lập hasher Bcrypt ổn định với cost=10.
...
- [x] Viậ¿t Controller `AuthController` (Đăng ký, Đăng nhập).
...
- [x] Thiậ¿t lập file `.gitignore` chuẩn ở thư mục gốc Monorepo bảo vệ và loại trừ các file tự sinh/nhạy cảm.
...
2. **Kiậ¿n trúc & Tương thích:**
   ...
   - Chấp nhận giữ cấu trúc PascalCase ở Database tạm thời cho đậ¿n Giai đoạn 7.
...
5. **Dọn dậ¹p code tạm:**
   - **[Bậ®T BUỘC]** Khi tạo ra các file tạm thời (ví dụ: file log, file dump, file test_models.php, file remove_bom.php...) để fix lỗi hoặc kiểm tra dữ liệu, nậ¿u file đó không còn dùng thì **PHậ¢I XÓA ĐI** ngay lập tức để giữ workspace sạch sậ½.
