...
1. **ðŸ”‘ Đăng nhập Nghiệp vụ (Security Login):** Đăng nhập nhanh bằng mÝsố HDV được cấp phép để đồng bộ dữ liệu tour thực tậ¿ từ văn phòng điều hành.
...
4. **ðŸ‘¥ Điểm danh du khách thông minh (Attendance Check):**
   ...
   * Hiển thị cảnh báo đỏ y tậ¿ đối với các hành khách có tiểu sử dị ứng/sức khỏe đặc biệt (bắt buộc HDV xác nhận).
   * Ghi nhận vắng mặt kèm lý do chi tiậ¿t cập nhật ngay lập tức lên ERP chính.
...
6. **ðŸ’µ Quyậ¿t toán chi phí thực địa (Expense Tracker):** Nhập khoản chi, chụp ảnh hóa đơn chứng từ và tự động trừ vào hạn mức tạm ứng của tour.
